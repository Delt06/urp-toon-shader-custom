Shader "DELTation/Custom/Additive Matcap"
{
    Properties
    {
        [MainTexture]
        ...
        [NoScaleOffset] [CustomProperty] _MatcapTexture ("Matcap", 2D) = "white" {}
...
SAMPLER(sampler_MatcapTexture); \
            ...
            // TOON_SHADER_HOOK_FORWARD_PASS_V2F
             #define TOON_SHADER_HOOK_FORWARD_PASS_V2F \
half2 matcap_uv : MATCAP_UV; \


            // TOON_SHADER_HOOK_VERTEX_INPUT
            // TOON_SHADER_HOOK_VERTEX_OUTPUT
             #define TOON_SHADER_HOOK_VERTEX_OUTPUT \
half2 matcap_uv = TransformWorldToViewDir(vertex_normal_inputs.normalWS).xy; \
...
const half4 matcap_sample = SAMPLE_TEXTURE2D(_MatcapTexture, sampler_MatcapTexture, input.matcap_uv); \
